...
//   useEffect(() => {
//     // Fetch coupons from your API when the component mounts
//     const fetchCoupons = async () => {
//       try {
//         const response = await axios.get('/api/v1/coupon/listCoupon'); // Adjust the URL based on your API endpoint
...
//             <p>Offer: {coupon.offer}</p>
//             <p>Discount Type: {coupon.discountType}</p>
//             <p>Sell Date: {coupon.sellDate}</p>
//             <p>Buyer ID: {coupon.buyerId}</p>
//             <p>Owner ID: {coupon.ownerId}</p>
//           </li>
//         ))}
//       </ul>
//     </div>
...
const CouponList = () => {
  ...
  useEffect(() => {
    const fetchCoupons = async () => {
      try {
        const response = await axios.get('/api/v1/coupon/listCoupon');
        setCoupons(response.data);
      } catch (error) {
        console.error('Error fetching coupons:', error);
      }
